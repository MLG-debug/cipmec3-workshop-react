...
export const Plan = ({ price, text, title, type, features, best }: PlanProps) => {
  ...
  return (
    <div className={`min-w-[320px] self-stretch p-8 bg-neutral-800 rounded-tl-[42px] rounded-tr-2xl rounded-bl-2xl rounded-br-3xl border flex-col justify-start items-center gap-8 inline-flex ${best ? "border-violet-600" : "border-zinc-500"} hover:border-violet-600 hover:scale-105 transition-all hover:shadow-lg hover:shadow-violet-600`}>
      {
        best &&
